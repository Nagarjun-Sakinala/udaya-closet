...
const WaveDivider = ({ position = 'bottom', color = 'fill-brand-cream' }) => {
    return (
        <div className={`absolute left-0 w-full overflow-hidden leading-[0] ${position === 'top' ? 'top-0 rotate-180' : 'bottom-0'}`}>
